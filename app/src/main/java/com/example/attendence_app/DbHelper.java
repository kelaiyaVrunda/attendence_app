...
public class DbHelper extends SQLiteOpenHelper {
    ...
    static {
        CREATE_CLASS_TABLE = "CREATE TABLE" + CLASS_TABLE_NAME + "(" +
                C_ID + " INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL," +
                CLASS_NAME_KEY + " TEXT NOT NULL," +
                SUBJECT_NAME_KEY + " TEXT NOT NULL," +
                "UNIQUE(" + CLASS_NAME_KEY + "," + SUBJECT_NAME_KEY + ")" +
                ");";
        DROP_CLASS_TABLE = "DROP TABLE IF EXISTS" + CLASS_TABLE_NAME;
    }



    
    private static final String tb = "TABLE";
    ...
    static {
        CREATE_STUDENT_TABLE= "CREATE TABLE" +STUDENT_TABLE_NAME+
                "("+
                ...
                ");";
        DROP_STUDENT_TABLE = "DROP TABLE IF EXISTS" + STUDENT_TABLE_NAME;
    ...
    static {
        CREATE_STATUS_TABLE = "CREATE TABLE" + STATUS_TABLE_NAME +
                ...
                "FOREIGN KEY(" +  C_ID + ")REFERENCES " +CLASS_TABLE_NAME + " ( " + C_ID + ")" +
                ");";
        DROP_STATUS_TABLE = "DROP TABLE IF EXISTS" + STATUS_TABLE_NAME;
    }
